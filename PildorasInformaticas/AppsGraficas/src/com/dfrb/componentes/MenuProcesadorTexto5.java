...
public class MenuProcesadorTexto5 {
    public static void main(String[] args) {
        MarcoProcesadorTexto5 miMarco = new MarcoProcesadorTexto5();
        miMarco.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        miMarco.setVisible(true);
    }
}

class MarcoProcesadorTexto5 extends JFrame {
    public MarcoProcesadorTexto5() {
        setTitle("Procesador de Textos con ComboBox");
        setBounds(500, 280, 600, 350);
        LaminaProcesadorTexto5 miLamina = new LaminaProcesadorTexto5();
        add(miLamina);
    }
}

class LaminaProcesadorTexto5 extends JPanel {
    public LaminaProcesadorTexto5() {
